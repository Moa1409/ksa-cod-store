...
const pillars = [
  ...
  { icon: ShieldCheck, title: "حلال ومعتمد", body: "ISO 22716 · حلال · GMP — شهادات تطمئنكِ قبل الدفع." },
...
const brandStats = [
  ...
  { value: "حلال", label: "ISO 22716 · GMP" },
...
const homeFaq = [
  ...
  {
    q: "هل المنتجات حلال ومعتمدة؟",
    a: "نعم — نتعامل مع مصانع تعلن شهادات حلال وISO 22716/GMPC (للتجميل) وGMP للمكملات، ونطلب شهادات التحليل قبل الشحن. نعرض فقط ما نملكه فعليًا.",
  },
        ...
        <div className="container-lg relative grid items-center gap-8 py-14 sm:py-20 md:grid-cols-2">
          <div className="order-1">
            <div className="relative">
              ...
              <div className="glass absolute -start-2 bottom-4 rounded-2xl px-4 py-3 shadow-soft">
                ...
                <div className="text-xs font-bold text-brand-plum">+٢٥٬٠٠٠ عميلة سعودية · حلال</div>
              </div>
            </div>
          </div>
          <div className="order-2">
            ...
            <p className="mt-4 text-lg text-brand-ink/85">
              ماسك كيراتين · عطر شعر حلال · علكات تقوية — روتين يعالج تلف الشعر وانتعاش الحجاب من جذور المشكلة، بشهادات تطمئنكِ والدفع عند الاستلام.
            </p>
        ...
        <div className="container-lg">
          ...
          <Section imageLabel="قصتنا" emoji="💗" reverse>
            <p className="text-lg">
              ...
              تركيبات كيراتين وعطور حلال ومكملات GMP، ودعمناها بشهادات ودفع عند الاستلام لأن ثقتكِ هي أول بيع لنا.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-brand-plum p-8 text-center text-brand-cream sm:p-14">
            ...
            <div className="relative">
              ...
              <div className="mt-4 text-sm text-brand-cream/70">
                ما تدفعين إلا عند الاستلام · حلال ومعتمد · استرجاع ٣٠ يوم · توصيل ٢–٤ أيام
              </div>
            </div>
          </div>
        </div>
