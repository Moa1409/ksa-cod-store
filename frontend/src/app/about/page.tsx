...
export const metadata: Metadata = {
  title: "من نحن",
  description: "قصة لمسة توهج — لماذا أسّسنا العيادة الجمالية المنزلية لكل امرأة سعودية.",
};

const values = [
  { icon: Lock, t: "الخصوصية أولًا", d: "جمالكِ شأنكِ الخاص — روتينكِ في بيتكِ وعلى وقتكِ." },
  { icon: BadgeCheck, t: "جودة معتمدة", d: "نختار أجهزة مطابقة لمعايير CE و RoHS واشتراطات SFDA." },
  { icon: Sparkles, t: "نتائج حقيقية", d: "تقنيات مدروسة تمنحكِ فرقًا تلاحظينه." },
...
const brandStats = [
  ...
  { value: "٣", label: "أجهزة مختارة بعناية" },
    ...
    <>
      <section className="relative overflow-hidden bg-mesh">
        ...
        <div className="container-lg relative py-14 text-center sm:py-20">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-brand-ink/85">
            بدأنا لمسة توهج من قناعة بسيطة: العناية بالجمال ما تحتاج تكون مكلفة ولا متعبة ولا على حساب
            خصوصيتكِ. جبنا لكِ أجهزة تجميل معتمدة تمنحكِ نتائج الصالون… وأنتِ مرتاحة في بيتكِ.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-lg space-y-14">
          <Section imageLabel="رؤيتنا" emoji="🌸" eyebrow="رؤيتنا" title="جمال بخصوصية لكل امرأة سعودية">
            <p className="text-lg">
              نطمح أن تكون لمسة توهج العلامة الأولى في العناية الجمالية المنزلية بالسعودية — نمكّن كل
              امرأة من روتين جمال راقٍ، بخصوصية وثقة، وبقيمة تدوم بدل الفواتير المتكررة.
            </p>
          </Section>
          <Section imageLabel="اختيارنا للمنتجات" emoji="🔬" eyebrow="جودتنا" title="كيف نختار منتجاتنا؟" reverse>
            <p className="text-lg">
              نختبر ونختار الأجهزة بعناية، ونركّز على الأمان والشهادات (CE · RoHS · اشتراطات SFDA)
              وسهولة الاستخدام والنتيجة. ونقف خلف كل منتج بضمان ودعم حقيقي.
            </p>
          </Section>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-lg text-center">
          <Link href="/shop" className="btn-primary text-lg">تسوّقي مجموعتنا</Link>
        </div>
      </section>
    </>
  );
