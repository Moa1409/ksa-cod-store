...
const values = [
  ...
  { icon: BadgeCheck, t: "حلال ومعتمد", d: "ISO 22716 · حلال · GMP — شهادات قبل ما تدفعين." },
      ...
      <section className="relative overflow-hidden bg-mesh">
        ...
        <div className="container-lg relative py-14 text-center sm:py-20">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-brand-ink/85">
            ...
            المصدر. جبنا لكِ ماسك كيراتين وعطر شعر حلال وعلكات تقوية… بخصوصية وثقة في بيتكِ.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-lg space-y-14">
          ...
          <Section imageLabel="اختيارنا للمنتجات" emoji="🔬" eyebrow="جودتنا" title="كيف نختار منتجاتنا؟" reverse>
            <p className="text-lg">
              نختار مصانع تعلن حلال وISO 22716/GMPC وGMP، ونطلب شهادات التحليل (COA) قبل الشحن. نرفض الوعود الطبية
