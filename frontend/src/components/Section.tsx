...
import { Media, type MediaAspect } from "@/components/Media";
...
export function Section({
  ...
  return (
    <div className={cn("grid items-center gap-8 md:grid-cols-2", className)}>
      ...
      <div className={cn("order-2", reverse ? "md:order-1" : "md:order-2")}>
        ...
        {title ? <h2 className="mb-3 text-2xl font-extrabold sm:text-3xl">{title}</h2> : null}
