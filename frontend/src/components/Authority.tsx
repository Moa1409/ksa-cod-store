...
const badges = [
  ...
  },
  {
    ...
    body: "مصانع تجميل بمعايير GMPC العالمية لماسك الكيراتين كولاجين وعطر الشعر.",
  },
  {
    icon: FlaskConical,
    title: "COA + علم المكوّنات",
    body: "شهادة تحليل للدفعة + شرح المكوّنات الفعّالة (كيراتين · كولاجين · بيوتين · أرغان).",
  },
  {
    icon: FileCheck2,
    title: "GMP للمكملات",
    body: "علكات الجمال من مصانع GMP / ISO 22000 / HACCP — شفافية بدون وعود طبية مبالغ فيها.",
  },
];
